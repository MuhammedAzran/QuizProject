...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/harrypottergame.css"></link>
    <title>Harry Potter game quiz</title>
</head>
<body>
    <div class="wrapper">
        <?php
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="answer">Norbert</label><input type="radio" class="radio" value="4" name="1"><br>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="answer">James and Lily Potter</label> <input type="radio" value="3" name="2"><br>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="answer">Vernon and Petunia Dursley</label><input type="radio" value="2" name="3"><br>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="answer">Avada Kedavra, Crucio and Imperio</label> <input type="radio" value="1" name="4"><br>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="answer">7</label> <input type="radio" value="3" name="5"><br>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="answer">The Prisoner of Azkaban</label> <input type="radio" value="4" name="6"><br>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="answer">1980</label> <input type="radio" value="4" name="7"><br>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="answer">Hedwig</label> <input type="radio" value="3" name="8"><br>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="answer">6</label><input type="radio" value="2" name="9"><br>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="answer">Ford Angila</label> <input type="radio" value="1" name="10"><br>
